                    ...
                    <div class="main-header-left">
                        ...
                        <div class="hor-logo">
                            <a class="main-logo" href="index.php.html">
                                <img src="{{ asset('dashboard/img/brand/logo.png') }}" class="header-brand-img desktop-logo" />
                            </a>
                        </div>
                    </div>
                    <div class="main-header-center">
                        <div class="responsive-logo">
                            <a href="index.php.php"><img src="{{ asset('dashboard/img/brand/logo.png') }}" class="mobile-logo" /></a>
                                ...
                                <div class="d-flex order-lg-2 ms-auto">
                                    ...
                                    <div class="dropdown main-profile-menu">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <a class="dropdown-item border-top" href="profile.php.html"> <i class="fa fa-user"></i> My Profile </a>
                                            <a class="dropdown-item" href="profile.php.html"> <i class="fa fa-edit"></i> Edit Profile </a>
                                            <a class="dropdown-item" href="signin.php"> <i class="fa fa-power-off"></i> Sign Out </a>
                                        </div>
                                    </div>
                                    <!-- Profile -->
                                </div>
                        ...
                        <div class="main-sidebar-body main-body-1">
                            ...
                            <ul class="menu-nav nav">
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="nav-sub">
                                        <li class="nav-sub-item"><a class="nav-sub-link" href="javascript:;">Employees</a></li>
                                        <li class="nav-sub-item"><a class="nav-sub-link" href="javascript:;">Customers</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link with-sub" href="javascript:void(0)">
                                    ...
                                    <ul class="nav-sub">
                                        ...
                                        <li class="nav-sub-item"><a class="nav-sub-link" href="javascript:void(0)">Products</a></li>
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="nav-sub">
                                        <li class="nav-sub-item"><a class="nav-sub-link" href="javascript:;">DoctLabsors</a></li>
                                        <li class="nav-sub-item"><a class="nav-sub-link" href="javascript:;">Doctors</a></li>
                                        <li class="nav-sub-item"><a class="nav-sub-link" href="javascript:;">Hospital</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="nav-sub">
                                        <li class="nav-sub-item"><a class="nav-sub-link" href="javascript:;">Hospital Services</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link with-sub" href="javascript:void(0)">
                                    ...
                                    <ul class="nav-sub">
                                        <li class="nav-sub-item"><a class="nav-sub-link" href="carousel.php.html">Lab Tests</a></li>
                                        <li class="nav-sub-item"><a class="nav-sub-link" href="collapse.php.html">Medicines</a></li>
                                    </ul>
                                </li>
                                ...
                                <li class="nav-item">
                                    ...
                                    <ul class="nav-sub">
                                        <li class="nav-sub-item"><a class="nav-sub-link" href="{{ route('list.roles') }}">Department Listing</a></li>
                                        <li class="nav-sub-item"><a class="nav-sub-link" href="{{ route('new.roles') }}">Department Create</a></li>
                                    </ul>
                                </li>
            ...
            <div class="main-footer text-center">
                <div class="container">
                    <div class="row row-sm">
                        <div class="col-md-12">
                            <span>Copyright © 2023 <a href="javascript:;">SmartSewa</a>. Designed by <a href="https://maishainfotech.com/" target="_blank">Maisha Infotech</a> All rights reserved.</span>
                        </div>
                    </div>
                </div>
            </div>
